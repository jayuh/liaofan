jQuery.extend({
    ...
    ajaxFileUpload: function (s) {
        ...
        var uploadCallback = function (isTimeout, code) {
            ...
            if (xml || isTimeout == "timeout") {
                ...
                try {
                    ...
                    if (status != "error") {
                        ...
                        jQuery.handleError(s, xml, status, '', code);
                } catch (e) {
                    status = "error";
        ...
        if (s.timeout > 0) {
            setTimeout(function () {
                ...
                if (!requestDone) uploadCallback("timeout", '999999');
            }, s.timeout);
        }
        try {
    ...
    handleError: function (s, xml, status, e, code) {
        // If a local callback was specified, fire it
        if (s.error)
            s.error(xml, status, e, code);
